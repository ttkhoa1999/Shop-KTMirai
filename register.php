...
<head>
    ...
    <title>Đăng ký || KT-Shop Mirai</title>
 ...
 <?php 
	...
	if(isset($_POST['submit'])){
		...
		if(empty($_POST['fname'])){
			$error['fname'] = 'Bạn chưa nhập họ lót';
		}
		if(empty($_POST['lname'])){
			$error['lname'] = 'Bạn chưa nhập tên';
		}
		if(empty($_POST['email'])){
			$error['email'] ='Bạn chưa nhập E-mail';
		}
		if(empty($_POST['sdt'])){
		...
		if(strlen($_POST['password']) < 6){
			$error['password'] = 'Mật khẩu phải lớn hơn 6 kí tự';
		}
		if($_POST['password']!=$_POST['rPassword']){
			$error['rPassword'] = 'Nhập lại mật khẩu không đúng';
		}
	//$otpradio = $_POST['otpradio'];
		if(empty($error)){
			$pass = password_hash($password, PASSWORD_DEFAULT);
			$sql 		= "insert into user(HoLot, Ten, Email, SDT, Password) values('$fname','$lname','$email','$sdt','$pass')";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="register-title">
                            ...
                            <p class="mb-10">Nếu bạn đã có tài khoản, vui lòng đăng nhập tại trang đăng nhập </p>
                        </div>
                    </div>
                </div>
                <!-- Row End -->
                        ...
                        <form class="form-register" method="post" action="#">
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="f-name"><span class="require">*</span>Họ Lót</label>
                                    <div class="col-md-10 error">
                                        <input type="text" class="form-control" id="f-name" placeholder="Họ Lót" name="fname">
                                        <span><?php echo (isset($error['fname'])) ? $error['fname'] : '' ?></span>
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="l-name"><span class="require">*</span>Tên</label>
                                    <div class="col-md-10 error">
                                        <input type="text" class="form-control" id="l-name" placeholder="Tên" name="lname">
                                        <span><?php echo (isset($error['lname'])) ? $error['lname'] : '' ?></span>
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="email"><span class="require">*</span>Nhập E-mail tại đây...</label>
                                    <div class="col-md-10 error">
                                        <input type="email" class="form-control" id="email" placeholder="Nhập E-mail của bạn..." name="email">
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10 error">
                                        <input type="text" class="form-control" id="number" placeholder="Số điện thoại" name="sdt">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10 error">
                                        <input type="password" class="form-control" id="pwd" placeholder="Mật khẩu phải lớn hơn 6 ký tự" name="password">
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10 error">
                                        <input type="password" class="form-control" id="pwd-confirm" placeholder="Nhập lại mật khẩu" name="rPassword">
                                        <span><?php echo (isset($error['rPassword'])) ? $error['rPassword'] : '' ?></span>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset class="newsletter-input">
                                <legend>Thông báo mới</legend>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="col-md-2 control-label">Theo dõi</label>
                            ...
                            <div class="terms">
                                <div class="float-md-right">
                                    ...
                                    <span>Tôi đã đọc và đồng ý với <a href="#" class="agree"><b>chính sách bảo mật và điều khoản của dịch vụ </b></a></span>
