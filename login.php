...
<head>
    ...
    <title>Đăng nhập || KT-Shop Mirai</title>
    	...
    	if(isset($_POST['submit'])){
    		...
    		if($checkEmail == 1){
    			...
    			if($checkPass){
    				...
    				$error['checkPass'] = 'Sai mật khẩu';
    			}
    		}else {
    			$error['email'] = 'E-mail không tồn tại';
    		}
                    ...
                    <div class="col-md-6">
                        <div class="well mb-sm-30">
                            <div class="new-customer">
                                <h3 class="custom-title">Đăng ký</h3>
                                <p>Là khách hàng mới, bằng cách tạo tài khoản, bạn sẽ có thể mua sắm nhanh hơn, cập nhật trạng thái đơn hàng và theo dõi các đơn hàng bạn đã thực hiện trước đó</p>
                            ...
                            <div class="return-customer">
                                ...
                                <form action="#" method="post">
                                    <div class="form-group error" >
                                        <label>Email</label>
                                        <input type="text" name="email" placeholder="Nhập E-mail của bạn..." id="input-email" class="form-control">
                                     	<span><?php echo (isset($error['email'])) ? $error['email'] : '' ?></span>
                                    </div>
                                    <div class="form-group error">
                                        <label>Password</label>
                                        <input type="password" name="pass" placeholder="Nhập mật khẩu" id="input-password" class="form-control">
                                    	 <span><?php echo (isset($error['checkPass'])) ? $error['checkPass'] : '' ?></span>
                                    </div>
                                    <p class="lost-password"><a href="forgot-password.php">Quên mật khẩu?</a></p>
                                    <input type="submit" name="submit" value="Đăng nhập" class="return-customer-btn">
                                </form>
                            </div>
                        </div>
                    </div>
