...
<head>
    ...
    <title>Quên mật khẩu || KT-Shop Mirai</title>
       ...
       <div class="popup_wrapper">
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="forgot-password.html">Quên mật khẩu</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
        ...
        if (isset($_POST['submit'])){
        	if (empty($_POST['email'])) { 
        		$error['email'] = "Bạn phải nhập địa chỉ email";
        	}else if (!empty($_POST['email']) && !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
        		$error['email'] = "Bạn phải nhập email đúng định dạng";
        	}
        	if (empty($error)) {
        		include 'library.php'; 
        		...
        		try {
        			...
        			$mail->setFrom(SMTP_UNAME, "Admin");
        			$mail->addAddress($_POST['email'], 'Người nhận');
        			$_SESSION['rEmail'] = $_POST['email'];
        			$mail->addReplyTo(SMTP_UNAME, 'Người gửi');
        			$mail->isHTML(true);    
        			$mail->Subject = "Tìm lại mật khẩu của bạn" ;
        			$mail->Body = "http://localhost:8080/php/TMDT/shop-KTMirai/rePassword.php";
        			$mail->AltBody = "http://localhost:8080/php/TMDT/shop-KTMirai/rePassword.php"; 
        			$result = $mail->send();
        			if (!$result) {
        	...
        	echo 'Đã gửi link đến E-mail của bạn!';
        }
        ...
        ?>
            ...
            <div class="container">
                <div class="register-title">
                    ...
                    <p class="mb-10">Nhập đúng tài khoản E-mail của bạn để tìm lại mật khẩu.</p>
                </div>
                <form class="password-forgot clearfix" method="post" action="">
                    <fieldset>
                        <legend>Thông tin cá nhân</legend>
                        <div class="form-group d-md-flex">
                            <label class="control-label col-md-2" for="email"><span class="require">*</span>Nhập E-mail của bạn tại đây...</label>
                            <div class="col-md-10 error" >
                                <input type="text" class="form-control" name="email" value="<?php echo (isset($_POST['email'])) ? $_POST['email'] : '' ;?>" id="email" placeholder="Nhập E-mail của bạn tại đây...">
